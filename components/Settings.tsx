...
// FIX: Imported the 'DownloadIcon' to resolve the 'Cannot find name' error.
        ...
        <div className="space-y-8">
            ...
            {currentUser.role === 'superuser' && (
             ...
             <div className="p-6 bg-white rounded-lg shadow-lg">
                <h3 className="text-lg font-semibold text-slate-800 border-b pb-3">Application Export &amp; Deployment</h3>
